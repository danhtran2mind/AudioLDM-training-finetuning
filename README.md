...
1. Download checkpoints (checkpoints.tar) from:
- [Google Drive](https://drive.google.com/file/d/1T6EnuAHIc8ioeZ9kB1OZ_WGgwXAVGOZS/view?usp=drive_link)
- [Zenodo](https://zenodo.org/records/14342967)
- [HuggingFace Model](https://huggingface.co/ayousanz/AudioLDM-training-finetuning)

The checkpoints including pretrained VAE, AudioMAE, CLAP, 16kHz HiFiGAN, and 48kHz HiFiGAN.

2. Uncompress the checkpoint tar file and place the content into **data/checkpoints/**
3. Download the preprocessed AudioCaps (dataset.tar) from:
- [Google Drive](https://drive.google.com/file/d/16J1CVu7EZPD_22FxitZ0TpOd__FwzOmx/view?usp=drive_link)
- [Zenodo](https://zenodo.org/records/14342967)
